...
typedef float               __qac_float32__;
typedef double              __qac_float64__;
...
/* _Floatn/_Floatnx support */
#if __GNUC__ > 6
typedef __qac_float32__ _Float16;
typedef __qac_float32__ _Float32;
typedef __qac_float32__ _Float32x;
typedef __qac_float64__ _Float64;
typedef __qac_float64__ _Float64x;
typedef __qac_float128__ _Float128;
typedef __qac_float128__ _Float128x;
#endif
typedef __qac_float64__ __float80;
typedef __qac_float128__ __float128;

#ifdef __XC16__
/* Microchip xc16-gcc built-in functions */

/* Based on DS52071B (1.10) and DS52071H (1.36) */

/* 8.10 COMPILER-SPECIFIC TYPE QUALIFIERS */
#define __psv__
#define __prog__
#define __eds__
...
#if __XC16_VERSION__ > 1010
int __builtin_ACCL__(int value);
int __builtin_ACCH__(int value);
int __builtin_ACCU__(int value);
#endif
int __builtin_add(int Accum,int value, const int shift);
int __builtin_addab(int Accum_a, int Accum_b);
#if __XC16_VERSION__ > 1010
unsigned int __builtin_addr_low__(void *symbol);
unsigned int __builtin_addr_high__(void *symbol);
unsigned int __builtin_addr_addr__(void *symbol);
#endif
void __builtin_btg(unsigned int *, unsigned int xn);
...
signed int __builtin_divmodsd(
 signed long dividend, signed int divisor, signed int *remainder);
...
int __builtin_edac(int Accum, int sqr,
  int **xptr, int xincr, int **yptr, int yincr, int *distance);
...
int __builtin_movsac(int **xptr, int *xval, int xincr,
  int **yptr, int *yval, int yincr, int *AWB, int AWB_accum);
int __builtin_mpy(int a, int b, int **xptr, int *xval, int xincr,
  int **yptr, int *yval, int yincr);
int __builtin_mpyn(int a, int b, int **xptr, int *xval, int xincr,
  int **yptr, int *yval, int yincr);
int __builtin_msc(int Accum, int a, int b, int **xptr, int *xval, int xincr,
  int **yptr, int *yval, int yincr, int *AWB, int AWB_accum);
...
#if __XC16_VERSION__ > 1010
void __builtin_write_DISICNT(int DISI_save);
#endif
...
#ifdef __XC32__
/* Microchip xc32-gcc built-in functions */
