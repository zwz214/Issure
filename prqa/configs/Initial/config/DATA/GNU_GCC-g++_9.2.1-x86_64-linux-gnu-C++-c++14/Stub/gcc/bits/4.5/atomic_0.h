...
#  undef _ATOMIC_CMPEXCHNG_
  template <typename T> T&& __qacpp_atomic_declvar();
#  define _ATOMIC_LOAD_(__a, __x) __qacpp_atomic_declvar<decltype(_ATOMIC_MEMBER_)>();
#  define _ATOMIC_STORE_(__a, __n, __x) __qacpp_atomic_declvar<decltype(__n)>();
#  define _ATOMIC_MODIFY_(__a, __o, __n, __x) __qacpp_atomic_declvar<decltype(_ATOMIC_MEMBER_)>();
#  define _ATOMIC_CMPEXCHNG_(__a, __e, __n, __x) __qacpp_atomic_declvar<bool> ();
#endif
  ...
  struct atomic_flag : public __atomic_flag_base
  {
    ...
    atomic_flag(bool __i): __atomic_flag_base(
...
#if ! defined (PRL_GCC_08)
    { return fetch_add(__d) + __d; }
#else
    { return reinterpret_cast<char*>(fetch_add(__d)) + __d; }
#endif
