...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
...
#if ((__PRL_GLIBCXX__ != 5) || ((__PRL_GLIBCXX__ == 5) && (__PRL_GLIBCXX_MINOR__ < 3)))
      template<bool __icase, bool __collate>
	void
#else
  ...
  template<typename _TraitsT, bool __icase, bool __collate>
	...
	auto __n = _M_translator._M_translate('\n');
	auto __r = _M_translator._M_translate('\r');
#if defined (PRL_GCC_11)
	auto __u2028 = _M_translator._M_translate(char16_t ('\u2028'));
	auto __u2029 = _M_translator._M_translate(char16_t ('\u2029'));
#else
